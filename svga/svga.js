    ...
    function (e, t, r) {
      ...
      Object.defineProperties(i.prototype, {
        ...
        (i.prototype.setup = function () {
          ...
          (this.encode = y(this)({ Writer: d, types: t, util: p })),
            (this.decode = m(this)({ Reader: c, types: t, util: p })),
            (this.verify = v(this)({ types: t, util: p })),
            (this.fromObject = g.fromObject(this)({ types: t, util: p })),
            (this.toObject = g.toObject(this)({ types: t, util: p }));
          var i = b[e];
          if (i) {
